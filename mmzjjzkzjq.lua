...
local Window = OrionLib:MakeWindow({Name = "北约中心", HidePremium = false, SaveConfig = true,IntroText = "苗中心", ConfigFolder = "苗中心"})
-----------------------------------------------------------------------------------------------------
...
about:AddLabel("该中心为完整版，永久免费")
about:AddLabel("自动更新")
about:AddParagraph("原作者","北约")
about:AddLabel("作者QQ:2399784507 更新以及反馈QQ群:387466948")
...
CreditsTab:AddParagraph("北约汉化qq23997845071")
